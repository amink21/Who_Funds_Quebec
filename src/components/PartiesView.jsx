...
export default function PartiesView({ parties, yearParty, cities, multi, donorDist }) {
  ...
  const distOptions = {
    ...
    plugins: {
      ...
      tooltip: { callbacks: { label: c => ` ${c.raw.toLocaleString()} ${t.parties.donationCount}` } },
    },
    scales: {
    ...
    <>
      ...
      <div className="grid-2">
        <div className="section">
          <div className="section-label">{t.parties.topParties}</div>
            ...
            return (
              <div key={name} className="party-row">
                <div className="party-header">
                  ...
                  <div className="party-meta">{fmt(total)} · {count.toLocaleString()} {t.parties.donors}</div>
                </div>
        ...
        <div className="section">
          <div className="section-label">{t.parties.byYear}</div>
          <div className="chart-wrap">
            <Bar data={yearData} options={yearOptions} />
          </div>
          <div style={{ marginTop: 24 }}>
            <div className="section-label">{t.parties.cities}</div>
      ...
      <div className="grid-2">
        <div className="section">
          <div className="section-label">{t.parties.profile}</div>
          <div className="chart-wrap">
            <Doughnut data={pieData} options={pieOptions} />
          </div>
        </div>
        <div className="section">
          <div className="section-label">{t.parties.multi}</div>
      ...
      <div className="grid-2">
        <div className="section">
          <div className="section-label">{t.parties.distLabel}</div>
          <div className="chart-wrap-lg">
            <Bar data={distData} options={distOptions} />
          </div>
        </div>
        <div className="section">
          <div className="section-label">{t.parties.distNote}</div>
